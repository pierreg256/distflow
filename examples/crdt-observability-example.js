...
const core_1 = require("@distflow/core");
const logger = (0, core_1.getLogger)('observability-example');
/**
 * Example 1: Real-time metrics monitoring
 */
function monitoringExample() {
    logger.info('=== Example 1: Real-time Metrics Monitoring ===');
    const crdt = new core_1.JSONCrdt('monitoring-replica', {});
...
function inspectionExample() {
    ...
    const crdt = new core_1.JSONCrdt('inspect-replica', { initial: 'state' });
    // Create some state
...
function snapshotDiffExample() {
    ...
    const crdt = new core_1.JSONCrdt('diff-replica', {});
    // Initial state
    crdt.set(['version'], 1);
    ...
    // Compare snapshots
    const diff = core_1.JSONCrdt.diffSnapshots(snap1, snap2);
...
function replayExample() {
    ...
    const crdt = new core_1.JSONCrdt('replay-replica', {});
    ...
    logger.info('Full state:', crdt.value());
    ...
    logger.info('State after replay:', partialState);
...
function causalGraphExample() {
    ...
    const crdt = new core_1.JSONCrdt('graph-replica', {});
...
function conflictExample() {
    ...
    const crdt = new core_1.JSONCrdt('conflict-replica', {});
    let conflicts = [];
...
function performanceExample() {
    ...
    const crdt = new core_1.JSONCrdt('perf-replica', {});
    // Simulate load
 ...
 */
class CrdtDashboard {
    constructor(crdt, reportIntervalMs = 5000) {
        this.crdt = crdt;
...
function dashboardExample() {
    ...
    const crdt = new core_1.JSONCrdt('dashboard-replica', {}, { maxLogSize: 50 });
